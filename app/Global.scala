  ...
  def insertSampleData() {
    ...
    if (Nail.findAll.isEmpty) {
      Seq(
        ...
        Nail(new ObjectId("5317c0d1d4d57996ce4b2a33"), "清新~(ˇˍˇ）", new ObjectId("53202c29d4d5e3cd47efffe3"), List("Airbrush","Patch","Crystal","Gel"), List("green","blue","purple","red","black","clear","multi"), List("metal","peucine","bridal","fruitSlices"), List("hand","foot"), "fresh", List("office","party","sport","date"), List(new OnUsePicture(new ObjectId, "main", Some(1), Option("FRONT"))), "超炫闪亮登场", date("2014-03-12"), true),
        ...
        Nail(new ObjectId("5317c0d1d4d57996ce4b2a35"), "可爱(～ o ～)Y", new ObjectId("53202c29d4d5e3cd47efffe3"), List("Airbrush","Patch","Crystal","Gel"), List("green","blue","purple","red","black","clear","multi"), List("metal","peucine","bridal","fruitSlices"), List("hand","foot"), "fresh", List("office","party","sport","date"), List(new OnUsePicture(new ObjectId, "main", Some(1), Option("FRONT"))), "超炫闪亮登场", date("2014-03-12"), true),
        Nail(new ObjectId("5317c0d1d4d57996ce4b2a36"), "多色变幻", new ObjectId("53202c29d4d5e3cd47efffe3"), List("Delineation","Patch","Pen","Gel"), List("green","blue","purple","red","black","clear","multi"), List("metal","peucine","bridal","fruitSlices"), List("hand","foot"), "fresh", List("office","party","sport","date"), List(new OnUsePicture(new ObjectId, "main", Some(1), Option("FRONT"))), "超炫闪亮登场", date("2014-03-12"), true),
        Nail(new ObjectId("5317c0d1d4d57996ce4b2a38"), "跳动的精灵", new ObjectId("53202c29d4d5e3cd47efffe3"), List("Airbrush","Pen","Crystal","Gel"), List("silver","beige","gold","orange","black","clear","multi"), List("metal","peucine","bridal","fruitSlices"), List("hand","foot"), "fresh", List("office","party","sport","date"), List(new OnUsePicture(new ObjectId, "main", Some(1), Option("FRONT"))), "超炫闪亮登场", date("2014-03-12"), true)).foreach(Nail.save)
    }
...
<p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: &#39;Microsoft YaHei&#39;, Arial, Helvetica, &#39;MS PGothic&#39;, sans-serif; font-size: 12px; line-height: 18px; white-space: normal;">
    ...
    if (Reservation.findAll.isEmpty) {
      Seq(
        Reservation(new ObjectId("5317c0d1d4d57997ce3e6d7a"), "demo06", new ObjectId("530d7288d7f2861457771bdd"), 3, dateTime("2014-04-11 10:00"), 90, None, List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), None, "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
        Reservation(new ObjectId("5317c0d1d4d57997ce3e6d7b"), "demo07", new ObjectId("530d7288d7f2861457771bdd"), 3, dateTime("2014-04-11 10:00"), 90, None, List(ResvItem("coupon", new ObjectId("5317c0d1d4d57997ce3e6d6a"), 1)), None, "051268320328", "准时到", 100, 0, 100, date("2014-04-11"), date("2014-04-11")),
